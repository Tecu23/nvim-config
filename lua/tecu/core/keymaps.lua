...
keymap("n", "<leader>sf", "<cmd>Telescope find_files<CR>", with_desc("Find files"))
keymap("n", "<leader>sg", "<cmd>Telescope live_grep<CR>", with_desc("Live grep"))
keymap("n", "<leader>sb", "<cmd>Telescope buffers<CR>", with_desc("Find buffers"))
keymap("n", "<leader>sh", "<cmd>Telescope help_tags<CR>", with_desc("Find help"))
keymap("n", "<leader>sr", "<cmd>Telescope oldfiles<CR>", with_desc("Recent files"))
keymap("n", "<leader>sc", "<cmd>Telescope commands<CR>", with_desc("Find commands"))
keymap("n", "<leader>sk", "<cmd>Telescope keymaps<CR>", with_desc("Find keymaps"))
keymap("n", "<leader>ss", "<cmd>Telescope git_status<CR>", with_desc("Git status"))
keymap("n", "<leader>sc", "<cmd>Telescope git_commits<CR>", with_desc("Git commits"))
keymap("n", "<leader>sb", "<cmd>Telescope git_branches<CR>", with_desc("Git branches"))
